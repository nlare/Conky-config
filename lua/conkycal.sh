...
COLOROLD="754d55" #MidSlateGrey
COLORTODAY="754d55" #DeepSkyBlue
COLORREST="754d55" #MidSlateGrey
COLORNEXT="754d55" #LightSlateGrey
COLORSATURDAY="754d55" #DeepSkyBlue
COLORSUNDAY="754d55" #DeepSkyBlue
COLOR=("" "" "" "" "" "\${color 754d55}" "\${color 754d55}")
COLOREND=("" "" "" "" "" "" "\${color 754d55}")
